<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <form id="form-update-country" method="POST" action="{{ route('kb.countries.update', $country) }}">
                @csrf
                @method('PATCH')
            ...
            <div class="flex justify-between items-center pt-4">
                ...
                <div class="flex gap-3">
                    ...
                    <x-dc.button form="form-update-country" type="submit" variant="action" size="s">Сохранить</x-dc.button>
                </div>
            </div>
        </div>
    </div>
