    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                ...
                <a href="{{ route('patients.index') }}" class="group bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition p-5 flex flex-col gap-3 border border-transparent hover:border-indigo-300 dark:hover:border-indigo-600">
                ...
                <a href="{{ route('cases.index') }}" class="group bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition p-5 flex flex-col gap-3 border border-transparent hover:border-indigo-300 dark:hover:border-indigo-600">
                ...
                <a href="{{ route('cases.board') }}" class="group bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition p-5 flex flex-col gap-3 border border-transparent hover:border-indigo-300 dark:hover:border-indigo-600">
                ...
                <a href="{{ route('kb.partners.index') }}" class="group bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition p-5 flex flex-col gap-3 border border-transparent hover:border-indigo-300 dark:hover:border-indigo-600">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <a href="{{ route('kb.countries.index') }}" class="group bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition p-5 flex flex-col gap-3 border border-transparent hover:border-teal-300 dark:hover:border-teal-600">
                ...
                <a href="{{ route('kb.niches.index') }}" class="group bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition p-5 flex flex-col gap-3 border border-transparent hover:border-teal-300 dark:hover:border-teal-600">
                    <div class="w-10 h-10 bg-teal-100 dark:bg-teal-900 rounded-lg flex items-center justify-center text-teal-600 dark:text-teal-300">
                ...
                <a href="{{ route('kb.country-directions.index') }}" class="group bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition p-5 flex flex-col gap-3 border border-transparent hover:border-teal-300 dark:hover:border-teal-600">
                    <div class="w-10 h-10 bg-teal-100 dark:bg-teal-900 rounded-lg flex items-center justify-center text-teal-600 dark:text-teal-300">
                ...
                <a href="{{ route('kb.verification-checklists.index') }}" class="group bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition p-5 flex flex-col gap-3 border border-transparent hover:border-teal-300 dark:hover:border-teal-600">
                    <div class="w-10 h-10 bg-teal-100 dark:bg-teal-900 rounded-lg flex items-center justify-center text-teal-600 dark:text-teal-300">
                ...
                <a href="{{ route('kb.message-templates.index') }}" class="group bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition p-5 flex flex-col gap-3 border border-transparent hover:border-teal-300 dark:hover:border-teal-600">
                    <div class="w-10 h-10 bg-teal-100 dark:bg-teal-900 rounded-lg flex items-center justify-center text-teal-600 dark:text-teal-300">
                ...
                <a href="{{ route('kb.partner-verifications.index') }}" class="group bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition p-5 flex flex-col gap-3 border border-transparent hover:border-teal-300 dark:hover:border-teal-600">
                    <div class="w-10 h-10 bg-teal-100 dark:bg-teal-900 rounded-lg flex items-center justify-center text-teal-600 dark:text-teal-300">
